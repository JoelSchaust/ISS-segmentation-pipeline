...
parser.add_argument('--fov', type=int, default="15", help='name of mutant')
...
parser.add_argument('--model', type=str, default="/home/s361852/Schreibtisch/in-situ-seq-segmentation/code/3nt_nuc_segmentation/Nucleus_Segmentation", help='custom model')
